...
class Product(db.Model):
    ...
    category = db.Column(db.String(50), nullable=False)  # cpu, gpu, motherboard, etc.
    image_url = db.Column(db.String(200))
    _specs = db.Column(db.Text, name='specs')  # JSON string of specs
    ...
    def specs(self, specs_dict):
        self._specs = json.dumps(specs_dict)
